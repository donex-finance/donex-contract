...
func compute_swap_step{
    ...
    let (sqrt_ratio_next: Uint256, amont_in: Uint256, amount_out: Uint256, fee_amount: Uint256) = SwapMath.compute_swap_step(sqrt_ratio_current, sqrt_ratio_target, liquidity, amount_remaining, fee_pips)
