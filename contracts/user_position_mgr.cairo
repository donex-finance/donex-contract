...
func _update_fees{
        ...
        range_check_ptr,
        bitwise_ptr: BitwiseBuiltin*
    }(position: UserPosition) -> (tokens_owed0: felt, tokens_owed1: felt, fee_growth_inside0_x128: Uint256, fee_growth_inside1_x128: Uint256):
    alloc_locals
    ...
    if is_valid == 1:
        ...
        let (tmp1: Uint256, _) = FullMath.uint256_mul_div(tmp, Uint256(position.liquidity, 0), Uint256(0, 1))
        ...
        let (tmp3: Uint256, _) = FullMath.uint256_mul_div(tmp2, Uint256(position.liquidity, 0), Uint256(0, 1))
        let tokens_owed1 = position.tokens_owed1 + tmp3.low

        return (tokens_owed0, tokens_owed1, slot_pos.fee_growth_inside0_x128, slot_pos.fee_growth_inside1_x128)
    end

    return (position.tokens_owed0, position.tokens_owed1, position.fee_growth_inside0_x128, position.fee_growth_inside1_x128)
end
...
func collect{
    ...
    let (tokens_owed0, tokens_owed1, fee_growth_inside0_x128: Uint256, fee_growth_inside1_x128: Uint256) = _update_fees(position)
    ...
    _positions.write(token_id, UserPosition(
